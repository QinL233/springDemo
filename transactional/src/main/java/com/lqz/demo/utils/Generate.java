...
public class Generate {
    ...
    //输出路径
    private static String out_put_dir = "C:\\Users\\liaoqinzhou_sz\\project\\idea\\springDemo\\transactional\\src\\main\\java";

    // 数据库配置
    private static String username = "root";
    private static String password = "root";
    private static String url = "jdbc:mysql://172.17.180.145:3306/test?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
